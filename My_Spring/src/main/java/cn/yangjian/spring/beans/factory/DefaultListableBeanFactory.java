...
/**
 * 1.基本的容器实现，继承AbstractBeanFactory
 ...
 * 注入到DefaultListableBeanFactory，后面在拓展工厂的时候，只需要继承DefaultListableBeanFactory
 * 就拥有了完整的beandefinition集合
 * 3.这里只能加载FileSystemResource，如需拓展，继承此类就可以
 */
public class DefaultListableBeanFactory extends AbstractBeanFactory
     ...
     * 可以给工厂直接注入资源，也可以直接注入资源地址，因为它是具备资源加载的能力的
     */
    ...
    /*
     * 资源的问题解决了，还得具备读取beandefinition的能力,本来是应该继承的容器中就具有了 读取的能力，这里为了简便，使用内部类实现
     */
    protected static class ResourceReaderBeanFactory extends XmlBeanDefinitionReader {
    ...
    private void invokeMethod(Object bean, String methodName, Class<?> parameterTypes, Object args) {
        try {
    ...
    private Object beanBasicTypeAutowired(Object bean, String depend) throws XmlConfigurationErrorException {
        ...
        try {
            ...
            if (typeName.equals(BasicType.Boolean.simpleTypeName)) {
                ...
                invokeMethod(bean, methodName, String.class, value);
